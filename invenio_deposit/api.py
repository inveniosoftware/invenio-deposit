...
class Deposit(Record):
    ...
    def add_file(self, filename, stream, location=None, storage_class=None):
    ...
    def rename_file(self, old_key, new_key):
        ...
        new_obj = ObjectVersion.create(bucket, new_key, _file_id=obj.file_id)
    ...
    def get_files(self):
        ...
        try:
            ...
            return ObjectVersion.get_by_bucket(bucket).all()
        except NoResultFound:
            return []

    def get_file(self, key, version_id):
        """Get a file."""
        # get the Bucket
        bucket = self.get_bucket()
        # serialize the file
    ...
    def delete_file(self, key):
        ...
        try:
            ...
            bucket = self.get_bucket()
            # delete the object
            return ObjectVersion.delete(bucket=bucket, key=key)
        except NoResultFound:
            return False
